    ...
    <div className="grid lg:grid-cols-2 gap-0 border-b border-gray-200">
      <div className="py-24 px-6 lg:px-16 bg-white order-2 lg:order-1 border-r border-gray-200">
        <FadeIn direction="right">
          ...
          <p className="text-xl text-textMain leading-relaxed font-normal max-w-xl mb-6">
            {CHAOS_DATA.subtitle}
          </p>
        ...
        <div className="relative z-10 w-full max-w-md space-y-6">
          <FadeIn delay={200} direction="up">
            <div className="p-0 bg-white border border-red-200 shadow-sm">
              ...
              <div className="p-6">
                ...
                <p className="font-mono text-xs text-primary font-bold uppercase">Critical: Operational Drift</p>
              </div>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-2 gap-4">
            <FadeIn delay={400} direction="up">
                ...
                <div>
                    <div className="font-mono text-[10px] text-textMain uppercase tracking-widest mb-1">Scale</div>
                    <div className="text-2xl font-bold text-primary">Exposes Gaps</div>
                </div>
                </div>
            </FadeIn>
            ...
            <FadeIn delay={600} direction="up">
                ...
                <div>
                    <div className="font-mono text-[10px] text-textMain uppercase tracking-widest mb-1">Efficiency</div>
                    <div className="text-2xl font-bold text-primary">Decaying</div>
                </div>
                </div>
            </FadeIn>
          </div>
           ...
           <FadeIn delay={800} direction="up">
            <div className="py-3 px-4 bg-primary text-white text-center">
                 <p className="font-mono text-[10px] font-bold uppercase tracking-widest">Status: Systems Stuck</p>
            </div>
           </FadeIn>
        </div>
      </div>
